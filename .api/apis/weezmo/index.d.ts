...
declare class SDK {
     ...
     */
    postApiSmscampaignCreate(body: types.PostApiSmscampaignCreateBodyParam): Promise<FetchResponse<200, types.PostApiSmscampaignCreateResponse200>>;
    /**
     * Get status of campaign by campaignId
     *
     * @throws FetchError<400, types.GetApiSmscampaignStatusCampaignidResponse400> Bad Request
     */
    getApiSmscampaignStatusCampaignid(metadata: types.GetApiSmscampaignStatusCampaignidMetadataParam): Promise<FetchResponse<200, types.GetApiSmscampaignStatusCampaignidResponse200>>;
    /**
     ...
     */
    postApiContactsList(body?: types.PostApiContactsListBodyParam): Promise<FetchResponse<200, types.PostApiContactsListResponse200>>;
    /**
     ...
     */
    postApiUnsubscribeList(body?: types.PostApiUnsubscribeListBodyParam): Promise<FetchResponse<200, types.PostApiUnsubscribeListResponse200>>;
    /**
     ...
     */
    postV3ExternalSendemailwithattachments(body: types.PostV3ExternalSendemailwithattachmentsBodyParam): Promise<FetchResponse<200, types.PostV3ExternalSendemailwithattachmentsResponse200>>;
    /**
     ...
     */
    postV2EntitiesReceiptAdditionalfile(body: types.PostV2EntitiesReceiptAdditionalfileBodyParam): Promise<FetchResponse<200, types.PostV2EntitiesReceiptAdditionalfileResponse200>>;
}
