  ...
  return (
    <>
      ...
      {state.showError.show && (
        <ErrorPopup
          isShow={state.showError.show}
          message={state.showError.message}
        />
      )}
      {state.showSuccess.show && (
        <SuccessPopup
          isShow={state.showSuccess.show}
          message={state.showSuccess.message}
        />
      )}
      {state.showWarning.show && (
        <WarningPopup
          isShow={state.showWarning.show}
          message={state.showWarning.message}
        />
      )}
